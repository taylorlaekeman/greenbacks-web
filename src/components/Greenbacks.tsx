...
import PreviousMonthSpending from 'components/PreviousMonthSpending';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/previous-month-spending/:month"
          element={<PreviousMonthSpending />}
        />
        <Route
          path="/previous-month-spending"
          element={<PreviousMonthSpending />}
        />
      </Routes>
    </>
